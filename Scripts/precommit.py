...
if __name__ == "__main__":
    ...
    print commands.getoutput('git clang-format -sort-includes=false --extensions "c,h,m,mm,cc,cp,cpp,c++,cxx,hh,hxx,cu,java,js,ts,cs" --commit %s' % clang_format_commit)
