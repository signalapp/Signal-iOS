...
public struct OWSCountryMetadata {
    ...
    public static let allCountryMetadatas: [OWSCountryMetadata] = [
        ...
        OWSCountryMetadata(name: "United Arab Emirates", frontingDomain: OWSFrontingHost.googleUae, countryCode: "AE"),
        ...
        OWSCountryMetadata(name: "Cuba", frontingDomain: OWSFrontingHost.fastly, countryCode: "CU"),
        ...
        OWSCountryMetadata(name: "Egypt", frontingDomain: OWSFrontingHost.googleEgypt, countryCode: "EG"),
        ...
        OWSCountryMetadata(name: "Oman", frontingDomain: OWSFrontingHost.googleOman, countryCode: "OM"),
        ...
        OWSCountryMetadata(name: "Qatar", frontingDomain: OWSFrontingHost.googleQatar, countryCode: "QA"),
        ...
        OWSCountryMetadata(name: "Russia", frontingDomain: OWSFrontingHost.fastly, countryCode: "RU"),
        ...
        OWSCountryMetadata(name: "Uzbekistan", frontingDomain: OWSFrontingHost.googleUzbekistan, countryCode: "UZ"),
        OWSCountryMetadata(name: "Saint Vincent and the Grenadines", frontingDomain: nil, countryCode: "VC"),
        OWSCountryMetadata(name: "Venezuela", frontingDomain: OWSFrontingHost.googleVenezuela, countryCode: "VE"),
