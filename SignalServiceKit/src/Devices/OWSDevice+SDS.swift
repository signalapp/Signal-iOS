...
extension OWSDeviceSerializer {
    ...
    static let deviceIdColumn = SDSColumnMetadata(columnName: "deviceId", columnType: .int64, columnIndex: 3)
    static let lastSeenAtColumn = SDSColumnMetadata(columnName: "lastSeenAt", columnType: .int64, columnIndex: 4)
    static let nameColumn = SDSColumnMetadata(columnName: "name", columnType: .unicodeString, isOptional: true, columnIndex: 5)
...
extension OWSDevice {
    ...
    public class func anyFetch(uniqueId: String,
        ...
        case .grdbRead(let grdbTransaction):
            let tableMetadata = OWSDeviceSerializer.table
            ...
            let uniqueIdColumnName: String = OWSDeviceSerializer.uniqueIdColumn.columnName
            ...
            let cursor = OWSDevice.grdbFetchCursor(sql: sql,
                                                  arguments: [uniqueId],
