...
extension Emoji {
    ...
    public var hasSkinTones: Bool { return emojiPerSkinTonePermutation != nil }
    public var allowsMultipleSkinTones: Bool { return hasSkinTones && skinToneComponentEmoji != nil }

    public var skinToneComponentEmoji: [Emoji]? {
        switch self {
    ...
    public var emojiPerSkinTonePermutation: [[SkinTone]: String]? {
        switch self {
        case .wave:
            return [
                [.light]: "👋🏻",
