...
public class GRDBDatabaseStorageAdapter: NSObject {
    ...
    lazy var migrator: DatabaseMigrator = {
        ...
        migrator.registerMigration("create initial schema") { db in
            ...
            try db.create(index: "index_interactions_for_special_messages",
                          on: InteractionRecord.databaseTableName,
                          columns: [
                            InteractionRecord.columnName(.threadUniqueId),
                            InteractionRecord.columnName(.errorType),
            ...
            try db.create(index: "index_interactions_for_inbox_thread_enumeration",
                          ...
                          columns: [
                            InteractionRecord.columnName(.threadUniqueId),
                            InteractionRecord.columnName(.storedShouldAppearInHomeView)
                ])
            ...
            try db.create(index: "index_interactions_on_threadUniqueId_and_read_and_storedShouldAffectUnreadCounts",
                          on: InteractionRecord.databaseTableName,
                          columns: [
                            InteractionRecord.columnName(.read),
                            InteractionRecord.columnName(.storedShouldAffectUnreadCounts),
                            InteractionRecord.columnName(.threadUniqueId)
                ])
