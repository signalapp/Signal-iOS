...
class OWSSendGiftBadgeJobRecordSerializer: SDSSerializer {
    ...
    func asRecord() throws -> SDSRecord {
        ...
        let paymentProcessor: String? = model.paymentProcessor
        let paypalPayerId: String? = model.paypalPayerId
        let paypalPaymentId: String? = model.paypalPaymentId
        let paypalPaymentToken: String? = model.paypalPaymentToken
