    ...
    private struct DBTableMapping {
        ...
        static var all: [DBTableMapping] {
            return [
                ...
                DBTableMapping(databaseTableName: "\(SignalAccount.databaseTableName)",
                               uuidColumn: SignalAccount.columnName(.recipientUUID),
                               phoneNumberColumn: SignalAccount.columnName(.recipientPhoneNumber)),
