...
class OWSDynamicOutgoingMessageSerializer: SDSSerializer {

    private let model: OWSDynamicOutgoingMessage
    public required init(model: OWSDynamicOutgoingMessage) {
        self.model = model
    }
    ...
    public func insertColumnValues() -> [DatabaseValueConvertible] {
        let result: [DatabaseValueConvertible] = [
            SDSRecordType.dynamicOutgoingMessage.rawValue
