...
class OWSDisappearingMessagesConfigurationMessageSerializer: SDSSerializer {

    private let model: OWSDisappearingMessagesConfigurationMessage
    public required init(model: OWSDisappearingMessagesConfigurationMessage) {
        self.model = model
    }
