...
/// Typing indicators are only delivered to online devices. Since they're ephemeral we just don't bother sending a typing
/// indicator to a recipient if we need the user to verify a safety number change.
/// Outgoing SKDMs being sent on behalf of an outgoing typing indicator should inherit this behavior.
