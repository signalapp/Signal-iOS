...
class OWSSyncConfigurationMessageSerializer: SDSSerializer {

    private let model: OWSSyncConfigurationMessage
    public required init(model: OWSSyncConfigurationMessage) {
        self.model = model
    }
    ...
    public func insertColumnValues() -> [DatabaseValueConvertible] {
        let result: [DatabaseValueConvertible] = [
            SDSRecordType.syncConfigurationMessage.rawValue
