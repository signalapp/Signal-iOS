...
class OWSOutgoingSyncMessageSerializer: SDSSerializer {

    private let model: OWSOutgoingSyncMessage
    public required init(model: OWSOutgoingSyncMessage) {
        self.model = model
    }
    ...
    public func insertColumnValues() -> [DatabaseValueConvertible] {
        let result: [DatabaseValueConvertible] = [
            SDSRecordType.outgoingSyncMessage.rawValue
