...
class OWSSyncContactsMessageSerializer: SDSSerializer {

    private let model: OWSSyncContactsMessage
    public required init(model: OWSSyncContactsMessage) {
        self.model = model
    }
    ...
    public func insertColumnValues() -> [DatabaseValueConvertible] {
        let result: [DatabaseValueConvertible] = [
            SDSRecordType.syncContactsMessage.rawValue
