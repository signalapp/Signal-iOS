...
class OWSSyncGroupsRequestMessageSerializer: SDSSerializer {

    private let model: OWSSyncGroupsRequestMessage
    public required init(model: OWSSyncGroupsRequestMessage) {
        self.model = model
    }
    ...
    public func insertColumnValues() -> [DatabaseValueConvertible] {
        let result: [DatabaseValueConvertible] = [
            SDSRecordType.syncGroupsRequestMessage.rawValue
