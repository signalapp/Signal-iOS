...
class OWSOutgoingSentMessageTranscriptSerializer: SDSSerializer {

    private let model: OWSOutgoingSentMessageTranscript
    public required init(model: OWSOutgoingSentMessageTranscript) {
        self.model = model
    }
    ...
    public func insertColumnValues() -> [DatabaseValueConvertible] {
        let result: [DatabaseValueConvertible] = [
            SDSRecordType.outgoingSentMessageTranscript.rawValue
    ...
    public func updateColumnNames() -> [String] {
        return [
            ...
            TSInteractionSerializer.isRecipientUpdateColumn,
            TSInteractionSerializer.messageColumn,
            TSInteractionSerializer.sentRecipientIdColumn
            ].map { $0.columnName }
    }
    ...
    public func updateColumnValues() -> [DatabaseValueConvertible] {
        let result: [DatabaseValueConvertible] = [
            ...
            self.model.isRecipientUpdate,
            SDSDeserializer.archive(self.model.message) ?? DatabaseValue.null,
            self.model.sentRecipientId ?? DatabaseValue.null
