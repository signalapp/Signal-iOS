...
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  ...
  if (self.hasAttachment) {
    [output appendFormat:@"%@%@ {\n", indent, @"attachment"];
    [self.attachment writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  [self.unknownFields writeDescriptionTo:output withIndent:indent];
...
- (OWSSignalServiceProtosDataMessageQuoteBuilder*) setAttachmentBuilder:(OWSSignalServiceProtosAttachmentPointerBuilder*) builderForValue {
...
- (OWSSignalServiceProtosDataMessageQuoteBuilder*) mergeAttachment:(OWSSignalServiceProtosAttachmentPointer*) value {
  if (resultQuote.hasAttachment &&
    ...
    resultQuote.attachment =
      [[[OWSSignalServiceProtosAttachmentPointer builderWithPrototype:resultQuote.attachment] mergeFrom:value] buildPartial];
  } else {
    resultQuote.attachment = value;
  }
  resultQuote.hasAttachment = YES;
