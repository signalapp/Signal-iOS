 ...
 */
public protocol CloudBackupProtoInputStream {
    ...
    func readHeader() -> CloudBackup.ProtoInputStreamReadResult<BackupProtoBackupInfo>

    /// Read a the next frame from the backup file.
    func readFrame() -> CloudBackup.ProtoInputStreamReadResult<BackupProtoFrame>

    /// Close the stream. Attempting to read after closing will result in failures.
    func closeFileStream()
}

internal class CloudBackupProtoInputStreamImpl: CloudBackupProtoInputStream {
    ...
    internal func readHeader() -> CloudBackup.ProtoInputStreamReadResult<BackupProtoBackupInfo> {
        return readProto(BackupProtoBackupInfo.init(serializedData:))
    }

    internal func readFrame() -> CloudBackup.ProtoInputStreamReadResult<BackupProtoFrame> {
    ...
    ) -> CloudBackup.ProtoInputStreamReadResult<T> {
