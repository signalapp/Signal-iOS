...
extension CloudBackup.ContactAddress {

    func asInteropAddress() -> CloudBackup.InteropAddress {
        return .init(serviceId: aci ?? pni, e164: e164)
    }

    func asArchivingAddress() -> CloudBackup.RecipientArchivingContext.Address {
        return .contact(self)
    }

    func asRestoringAddress() -> CloudBackup.RecipientRestoringContext.Address {
        return .contact(self)
    }
}

extension CloudBackup.InteropAddress {
    ...
    func asSingleServiceIdBackupAddress() -> CloudBackup.ContactAddress? {
        return .init(
...
extension BackupProtoContact {
    ...
    var address: CloudBackup.ContactAddress? {
        return .init(
