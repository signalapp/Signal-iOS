...
public enum BackupProto_GroupV2AccessLevel: SwiftProtobuf.Enum {
...
extension BackupProto_GroupV2AccessLevel: CaseIterable {
...
public struct BackupProto_BackupInfo {
...
public struct BackupProto_Frame {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: BackupProto_Frame.OneOf_Item, rhs: BackupProto_Frame.OneOf_Item) -> Bool {
      ...
      case (.recipient, .recipient): return {
        guard case .recipient(let l) = lhs, case .recipient(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      ...
      case (.chatItem, .chatItem): return {
        guard case .chatItem(let l) = lhs, case .chatItem(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.stickerPack, .stickerPack): return {
        guard case .stickerPack(let l) = lhs, case .stickerPack(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.adHocCall, .adHocCall): return {
        guard case .adHocCall(let l) = lhs, case .adHocCall(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
public struct BackupProto_AccountData {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum PhoneNumberSharingMode: SwiftProtobuf.Enum {
    public typealias RawValue = Int
    case unknown // = 0
    case everybody // = 1
    case nobody // = 2
...
extension BackupProto_AccountData.PhoneNumberSharingMode: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension BackupProto_AccountData.UsernameLink.Color: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct BackupProto_Recipient {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: BackupProto_Recipient.OneOf_Destination, rhs: BackupProto_Recipient.OneOf_Destination) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      ...
      case (.releaseNotes, .releaseNotes): return {
        guard case .releaseNotes(let l) = lhs, case .releaseNotes(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
public struct BackupProto_Contact {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum OneOf_Registration: Equatable {
    case registered(BackupProto_Contact.Registered)
    case notRegistered(BackupProto_Contact.NotRegistered)

  #if !swift(>=4.1)
    public static func ==(lhs: BackupProto_Contact.OneOf_Registration, rhs: BackupProto_Contact.OneOf_Registration) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      ...
      case (.notRegistered, .notRegistered): return {
        guard case .notRegistered(let l) = lhs, case .notRegistered(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
...
extension BackupProto_Contact.Visibility: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct BackupProto_Group {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum StorySendMode: SwiftProtobuf.Enum {
    public typealias RawValue = Int
    case `default` // = 0
    case disabled // = 1
    case enabled // = 2
  ...
  public struct GroupAttributeBlob {
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: BackupProto_Group.GroupAttributeBlob.OneOf_Content, rhs: BackupProto_Group.GroupAttributeBlob.OneOf_Content) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
  ...
  public struct AccessControl {
    ...
    public enum AccessRequired: SwiftProtobuf.Enum {
      public typealias RawValue = Int
      case unknown // = 0
      case any // = 1
      case member // = 2
...
extension BackupProto_Group.StorySendMode: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension BackupProto_Group.Member.Role: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension BackupProto_Group.AccessControl.AccessRequired: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct BackupProto_Self {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_ReleaseNotes {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_Chat {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_CallLink {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum Restrictions: SwiftProtobuf.Enum {
    public typealias RawValue = Int
    case unknown // = 0
    case none // = 1
...
extension BackupProto_CallLink.Restrictions: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct BackupProto_AdHocCall {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension BackupProto_AdHocCall.State: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct BackupProto_DistributionListItem {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: BackupProto_DistributionListItem.OneOf_Item, rhs: BackupProto_DistributionListItem.OneOf_Item) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.deletionTimestamp, .deletionTimestamp): return {
        guard case .deletionTimestamp(let l) = lhs, case .deletionTimestamp(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.distributionList, .distributionList): return {
        guard case .distributionList(let l) = lhs, case .distributionList(let r) = rhs else { preconditionFailure() }
...
public struct BackupProto_DistributionList {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum PrivacyMode: SwiftProtobuf.Enum {
    public typealias RawValue = Int
    case unknown // = 0
    case onlyWith // = 1
    case allExcept // = 2
...
extension BackupProto_DistributionList.PrivacyMode: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct BackupProto_ChatItem {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum OneOf_DirectionalDetails: Equatable {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: BackupProto_ChatItem.OneOf_DirectionalDetails, rhs: BackupProto_ChatItem.OneOf_DirectionalDetails) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      ...
      case (.directionless, .directionless): return {
        guard case .directionless(let l) = lhs, case .directionless(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: BackupProto_ChatItem.OneOf_Item, rhs: BackupProto_ChatItem.OneOf_Item) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.standardMessage, .standardMessage): return {
        guard case .standardMessage(let l) = lhs, case .standardMessage(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      ...
      case (.stickerMessage, .stickerMessage): return {
        guard case .stickerMessage(let l) = lhs, case .stickerMessage(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.remoteDeletedMessage, .remoteDeletedMessage): return {
        guard case .remoteDeletedMessage(let l) = lhs, case .remoteDeletedMessage(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.updateMessage, .updateMessage): return {
        guard case .updateMessage(let l) = lhs, case .updateMessage(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.paymentNotification, .paymentNotification): return {
        guard case .paymentNotification(let l) = lhs, case .paymentNotification(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.giftBadge, .giftBadge): return {
        guard case .giftBadge(let l) = lhs, case .giftBadge(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
...
public struct BackupProto_SendStatus {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_Text {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_StandardMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_ContactMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_PaymentNotification {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public struct TransactionDetails {
    ...
    public enum OneOf_Payment: Equatable {
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: BackupProto_PaymentNotification.TransactionDetails.OneOf_Payment, rhs: BackupProto_PaymentNotification.TransactionDetails.OneOf_Payment) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
        ...
        case (.failedTransaction, .failedTransaction): return {
          guard case .failedTransaction(let l) = lhs, case .failedTransaction(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        default: return false
        }
...
extension BackupProto_PaymentNotification.TransactionDetails.FailedTransaction.FailureReason: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension BackupProto_PaymentNotification.TransactionDetails.Transaction.Status: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct BackupProto_GiftBadge {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension BackupProto_GiftBadge.State: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct BackupProto_ContactAttachment {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension BackupProto_ContactAttachment.Phone.TypeEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension BackupProto_ContactAttachment.Email.TypeEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension BackupProto_ContactAttachment.PostalAddress.TypeEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct BackupProto_StickerMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_RemoteDeletedMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_Sticker {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_LinkPreview {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_MessageAttachment {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension BackupProto_MessageAttachment.Flag: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct BackupProto_FilePointer {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum OneOf_Locator: Equatable {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: BackupProto_FilePointer.OneOf_Locator, rhs: BackupProto_FilePointer.OneOf_Locator) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.backupLocator, .backupLocator): return {
        guard case .backupLocator(let l) = lhs, case .backupLocator(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.attachmentLocator, .attachmentLocator): return {
        guard case .attachmentLocator(let l) = lhs, case .attachmentLocator(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.invalidAttachmentLocator, .invalidAttachmentLocator): return {
        guard case .invalidAttachmentLocator(let l) = lhs, case .invalidAttachmentLocator(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
...
public struct BackupProto_Quote {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension BackupProto_Quote.TypeEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct BackupProto_BodyRange {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum OneOf_AssociatedValue: Equatable {
    case mentionAci(Data)
    case style(BackupProto_BodyRange.Style)

  #if !swift(>=4.1)
    public static func ==(lhs: BackupProto_BodyRange.OneOf_AssociatedValue, rhs: BackupProto_BodyRange.OneOf_AssociatedValue) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.mentionAci, .mentionAci): return {
        guard case .mentionAci(let l) = lhs, case .mentionAci(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
extension BackupProto_BodyRange.Style: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct BackupProto_Reaction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_ChatUpdateMessage {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: BackupProto_ChatUpdateMessage.OneOf_Update, rhs: BackupProto_ChatUpdateMessage.OneOf_Update) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.simpleUpdate, .simpleUpdate): return {
        guard case .simpleUpdate(let l) = lhs, case .simpleUpdate(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.groupChange, .groupChange): return {
        guard case .groupChange(let l) = lhs, case .groupChange(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.expirationTimerChange, .expirationTimerChange): return {
        guard case .expirationTimerChange(let l) = lhs, case .expirationTimerChange(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.profileChange, .profileChange): return {
        guard case .profileChange(let l) = lhs, case .profileChange(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.threadMerge, .threadMerge): return {
        guard case .threadMerge(let l) = lhs, case .threadMerge(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.sessionSwitchover, .sessionSwitchover): return {
        guard case .sessionSwitchover(let l) = lhs, case .sessionSwitchover(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.individualCall, .individualCall): return {
        guard case .individualCall(let l) = lhs, case .individualCall(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.groupCall, .groupCall): return {
        guard case .groupCall(let l) = lhs, case .groupCall(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.learnedProfileChange, .learnedProfileChange): return {
        guard case .learnedProfileChange(let l) = lhs, case .learnedProfileChange(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
...
public struct BackupProto_IndividualCall {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension BackupProto_IndividualCall.TypeEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension BackupProto_IndividualCall.Direction: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension BackupProto_IndividualCall.State: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct BackupProto_GroupCall {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension BackupProto_GroupCall.State: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct BackupProto_SimpleChatUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension BackupProto_SimpleChatUpdate.TypeEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct BackupProto_ExpirationTimerChatUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_ProfileChangeChatUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_LearnedProfileChatUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum OneOf_PreviousName: Equatable {
    case e164(UInt64)
    case username(String)

  #if !swift(>=4.1)
    public static func ==(lhs: BackupProto_LearnedProfileChatUpdate.OneOf_PreviousName, rhs: BackupProto_LearnedProfileChatUpdate.OneOf_PreviousName) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.e164, .e164): return {
        guard case .e164(let l) = lhs, case .e164(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
public struct BackupProto_ThreadMergeChatUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_SessionSwitchoverChatUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupChangeChatUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public struct Update {
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: BackupProto_GroupChangeChatUpdate.Update.OneOf_Update, rhs: BackupProto_GroupChangeChatUpdate.Update.OneOf_Update) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
        case (.genericGroupUpdate, .genericGroupUpdate): return {
          guard case .genericGroupUpdate(let l) = lhs, case .genericGroupUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupCreationUpdate, .groupCreationUpdate): return {
          guard case .groupCreationUpdate(let l) = lhs, case .groupCreationUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupNameUpdate, .groupNameUpdate): return {
          guard case .groupNameUpdate(let l) = lhs, case .groupNameUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupAvatarUpdate, .groupAvatarUpdate): return {
          guard case .groupAvatarUpdate(let l) = lhs, case .groupAvatarUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupDescriptionUpdate, .groupDescriptionUpdate): return {
          guard case .groupDescriptionUpdate(let l) = lhs, case .groupDescriptionUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupMembershipAccessLevelChangeUpdate, .groupMembershipAccessLevelChangeUpdate): return {
          guard case .groupMembershipAccessLevelChangeUpdate(let l) = lhs, case .groupMembershipAccessLevelChangeUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupAttributesAccessLevelChangeUpdate, .groupAttributesAccessLevelChangeUpdate): return {
          guard case .groupAttributesAccessLevelChangeUpdate(let l) = lhs, case .groupAttributesAccessLevelChangeUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupAnnouncementOnlyChangeUpdate, .groupAnnouncementOnlyChangeUpdate): return {
          guard case .groupAnnouncementOnlyChangeUpdate(let l) = lhs, case .groupAnnouncementOnlyChangeUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupAdminStatusUpdate, .groupAdminStatusUpdate): return {
          guard case .groupAdminStatusUpdate(let l) = lhs, case .groupAdminStatusUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupMemberLeftUpdate, .groupMemberLeftUpdate): return {
          guard case .groupMemberLeftUpdate(let l) = lhs, case .groupMemberLeftUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupMemberRemovedUpdate, .groupMemberRemovedUpdate): return {
          guard case .groupMemberRemovedUpdate(let l) = lhs, case .groupMemberRemovedUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.selfInvitedToGroupUpdate, .selfInvitedToGroupUpdate): return {
          guard case .selfInvitedToGroupUpdate(let l) = lhs, case .selfInvitedToGroupUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.selfInvitedOtherUserToGroupUpdate, .selfInvitedOtherUserToGroupUpdate): return {
          guard case .selfInvitedOtherUserToGroupUpdate(let l) = lhs, case .selfInvitedOtherUserToGroupUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupUnknownInviteeUpdate, .groupUnknownInviteeUpdate): return {
          guard case .groupUnknownInviteeUpdate(let l) = lhs, case .groupUnknownInviteeUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupInvitationAcceptedUpdate, .groupInvitationAcceptedUpdate): return {
          guard case .groupInvitationAcceptedUpdate(let l) = lhs, case .groupInvitationAcceptedUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupInvitationDeclinedUpdate, .groupInvitationDeclinedUpdate): return {
          guard case .groupInvitationDeclinedUpdate(let l) = lhs, case .groupInvitationDeclinedUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupMemberJoinedUpdate, .groupMemberJoinedUpdate): return {
          guard case .groupMemberJoinedUpdate(let l) = lhs, case .groupMemberJoinedUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupMemberAddedUpdate, .groupMemberAddedUpdate): return {
          guard case .groupMemberAddedUpdate(let l) = lhs, case .groupMemberAddedUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupSelfInvitationRevokedUpdate, .groupSelfInvitationRevokedUpdate): return {
          guard case .groupSelfInvitationRevokedUpdate(let l) = lhs, case .groupSelfInvitationRevokedUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupInvitationRevokedUpdate, .groupInvitationRevokedUpdate): return {
          guard case .groupInvitationRevokedUpdate(let l) = lhs, case .groupInvitationRevokedUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupJoinRequestUpdate, .groupJoinRequestUpdate): return {
          guard case .groupJoinRequestUpdate(let l) = lhs, case .groupJoinRequestUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupJoinRequestApprovalUpdate, .groupJoinRequestApprovalUpdate): return {
          guard case .groupJoinRequestApprovalUpdate(let l) = lhs, case .groupJoinRequestApprovalUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupJoinRequestCanceledUpdate, .groupJoinRequestCanceledUpdate): return {
          guard case .groupJoinRequestCanceledUpdate(let l) = lhs, case .groupJoinRequestCanceledUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupInviteLinkResetUpdate, .groupInviteLinkResetUpdate): return {
          guard case .groupInviteLinkResetUpdate(let l) = lhs, case .groupInviteLinkResetUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupInviteLinkEnabledUpdate, .groupInviteLinkEnabledUpdate): return {
          guard case .groupInviteLinkEnabledUpdate(let l) = lhs, case .groupInviteLinkEnabledUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupInviteLinkAdminApprovalUpdate, .groupInviteLinkAdminApprovalUpdate): return {
          guard case .groupInviteLinkAdminApprovalUpdate(let l) = lhs, case .groupInviteLinkAdminApprovalUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupInviteLinkDisabledUpdate, .groupInviteLinkDisabledUpdate): return {
          guard case .groupInviteLinkDisabledUpdate(let l) = lhs, case .groupInviteLinkDisabledUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupMemberJoinedByLinkUpdate, .groupMemberJoinedByLinkUpdate): return {
          guard case .groupMemberJoinedByLinkUpdate(let l) = lhs, case .groupMemberJoinedByLinkUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupV2MigrationUpdate, .groupV2MigrationUpdate): return {
          guard case .groupV2MigrationUpdate(let l) = lhs, case .groupV2MigrationUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupV2MigrationSelfInvitedUpdate, .groupV2MigrationSelfInvitedUpdate): return {
          guard case .groupV2MigrationSelfInvitedUpdate(let l) = lhs, case .groupV2MigrationSelfInvitedUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupV2MigrationInvitedMembersUpdate, .groupV2MigrationInvitedMembersUpdate): return {
          guard case .groupV2MigrationInvitedMembersUpdate(let l) = lhs, case .groupV2MigrationInvitedMembersUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupV2MigrationDroppedMembersUpdate, .groupV2MigrationDroppedMembersUpdate): return {
          guard case .groupV2MigrationDroppedMembersUpdate(let l) = lhs, case .groupV2MigrationDroppedMembersUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupSequenceOfRequestsAndCancelsUpdate, .groupSequenceOfRequestsAndCancelsUpdate): return {
          guard case .groupSequenceOfRequestsAndCancelsUpdate(let l) = lhs, case .groupSequenceOfRequestsAndCancelsUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.groupExpirationTimerUpdate, .groupExpirationTimerUpdate): return {
          guard case .groupExpirationTimerUpdate(let l) = lhs, case .groupExpirationTimerUpdate(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        default: return false
        }
...
public struct BackupProto_GenericGroupUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupCreationUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupNameUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupAvatarUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupDescriptionUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupMembershipAccessLevelChangeUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupAttributesAccessLevelChangeUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupAnnouncementOnlyChangeUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupAdminStatusUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupMemberLeftUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupMemberRemovedUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_SelfInvitedToGroupUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_SelfInvitedOtherUserToGroupUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupUnknownInviteeUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupInvitationAcceptedUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupInvitationDeclinedUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupMemberJoinedUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupMemberAddedUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupSelfInvitationRevokedUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupInvitationRevokedUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupJoinRequestUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupJoinRequestApprovalUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupJoinRequestCanceledUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupSequenceOfRequestsAndCancelsUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupInviteLinkResetUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupInviteLinkEnabledUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupInviteLinkAdminApprovalUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupInviteLinkDisabledUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupMemberJoinedByLinkUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupV2MigrationUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupV2MigrationSelfInvitedUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupV2MigrationInvitedMembersUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupV2MigrationDroppedMembersUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_GroupExpirationTimerUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_StickerPack {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BackupProto_ChatStyle {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: BackupProto_ChatStyle.OneOf_Wallpaper, rhs: BackupProto_ChatStyle.OneOf_Wallpaper) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.wallpaperPreset, .wallpaperPreset): return {
        guard case .wallpaperPreset(let l) = lhs, case .wallpaperPreset(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.wallpaperPhoto, .wallpaperPhoto): return {
        guard case .wallpaperPhoto(let l) = lhs, case .wallpaperPhoto(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
  ...
  public enum OneOf_BubbleColor: Equatable {
    /// Bubble setting is automatically determined based on the wallpaper setting,
    /// or `SOLID_ULTRAMARINE` for `noWallpaper`
    ...
    public static func ==(lhs: BackupProto_ChatStyle.OneOf_BubbleColor, rhs: BackupProto_ChatStyle.OneOf_BubbleColor) -> Bool {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.autoBubbleColor, .autoBubbleColor): return {
        guard case .autoBubbleColor(let l) = lhs, case .autoBubbleColor(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.bubbleColorPreset, .bubbleColorPreset): return {
        guard case .bubbleColorPreset(let l) = lhs, case .bubbleColorPreset(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.customColorID, .customColorID): return {
        guard case .customColorID(let l) = lhs, case .customColorID(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
  ...
  public enum WallpaperPreset: SwiftProtobuf.Enum {
    public typealias RawValue = Int
  ...
  public enum BubbleColorPreset: SwiftProtobuf.Enum {
    public typealias RawValue = Int
  ...
  public struct CustomChatColor {
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: BackupProto_ChatStyle.CustomChatColor.OneOf_Color, rhs: BackupProto_ChatStyle.CustomChatColor.OneOf_Color) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
        case (.solid, .solid): return {
          guard case .solid(let l) = lhs, case .solid(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.gradient, .gradient): return {
          guard case .gradient(let l) = lhs, case .gradient(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        default: return false
        }
...
extension BackupProto_ChatStyle.WallpaperPreset: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension BackupProto_ChatStyle.BubbleColorPreset: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension BackupProto_GroupV2AccessLevel: @unchecked Sendable {}
extension BackupProto_BackupInfo: @unchecked Sendable {}
extension BackupProto_Frame: @unchecked Sendable {}
extension BackupProto_Frame.OneOf_Item: @unchecked Sendable {}
extension BackupProto_AccountData: @unchecked Sendable {}
extension BackupProto_AccountData.PhoneNumberSharingMode: @unchecked Sendable {}
extension BackupProto_AccountData.UsernameLink: @unchecked Sendable {}
extension BackupProto_AccountData.UsernameLink.Color: @unchecked Sendable {}
extension BackupProto_AccountData.AccountSettings: @unchecked Sendable {}
extension BackupProto_AccountData.SubscriberData: @unchecked Sendable {}
extension BackupProto_Recipient: @unchecked Sendable {}
extension BackupProto_Recipient.OneOf_Destination: @unchecked Sendable {}
extension BackupProto_Contact: @unchecked Sendable {}
extension BackupProto_Contact.OneOf_Registration: @unchecked Sendable {}
extension BackupProto_Contact.Visibility: @unchecked Sendable {}
extension BackupProto_Contact.Registered: @unchecked Sendable {}
extension BackupProto_Contact.NotRegistered: @unchecked Sendable {}
extension BackupProto_Group: @unchecked Sendable {}
extension BackupProto_Group.StorySendMode: @unchecked Sendable {}
extension BackupProto_Group.GroupSnapshot: @unchecked Sendable {}
extension BackupProto_Group.GroupAttributeBlob: @unchecked Sendable {}
extension BackupProto_Group.GroupAttributeBlob.OneOf_Content: @unchecked Sendable {}
extension BackupProto_Group.Member: @unchecked Sendable {}
extension BackupProto_Group.Member.Role: @unchecked Sendable {}
extension BackupProto_Group.MemberPendingProfileKey: @unchecked Sendable {}
extension BackupProto_Group.MemberPendingAdminApproval: @unchecked Sendable {}
extension BackupProto_Group.MemberBanned: @unchecked Sendable {}
extension BackupProto_Group.AccessControl: @unchecked Sendable {}
extension BackupProto_Group.AccessControl.AccessRequired: @unchecked Sendable {}
extension BackupProto_Self: @unchecked Sendable {}
extension BackupProto_ReleaseNotes: @unchecked Sendable {}
extension BackupProto_Chat: @unchecked Sendable {}
extension BackupProto_CallLink: @unchecked Sendable {}
extension BackupProto_CallLink.Restrictions: @unchecked Sendable {}
extension BackupProto_AdHocCall: @unchecked Sendable {}
extension BackupProto_AdHocCall.State: @unchecked Sendable {}
extension BackupProto_DistributionListItem: @unchecked Sendable {}
extension BackupProto_DistributionListItem.OneOf_Item: @unchecked Sendable {}
extension BackupProto_DistributionList: @unchecked Sendable {}
extension BackupProto_DistributionList.PrivacyMode: @unchecked Sendable {}
extension BackupProto_ChatItem: @unchecked Sendable {}
extension BackupProto_ChatItem.OneOf_DirectionalDetails: @unchecked Sendable {}
extension BackupProto_ChatItem.OneOf_Item: @unchecked Sendable {}
extension BackupProto_ChatItem.IncomingMessageDetails: @unchecked Sendable {}
...
extension BackupProto_PaymentNotification: @unchecked Sendable {}
extension BackupProto_PaymentNotification.TransactionDetails: @unchecked Sendable {}
extension BackupProto_PaymentNotification.TransactionDetails.OneOf_Payment: @unchecked Sendable {}
extension BackupProto_PaymentNotification.TransactionDetails.MobileCoinTxoIdentification: @unchecked Sendable {}
extension BackupProto_PaymentNotification.TransactionDetails.FailedTransaction: @unchecked Sendable {}
extension BackupProto_PaymentNotification.TransactionDetails.FailedTransaction.FailureReason: @unchecked Sendable {}
extension BackupProto_PaymentNotification.TransactionDetails.Transaction: @unchecked Sendable {}
extension BackupProto_PaymentNotification.TransactionDetails.Transaction.Status: @unchecked Sendable {}
extension BackupProto_GiftBadge: @unchecked Sendable {}
extension BackupProto_GiftBadge.State: @unchecked Sendable {}
extension BackupProto_ContactAttachment: @unchecked Sendable {}
extension BackupProto_ContactAttachment.Name: @unchecked Sendable {}
extension BackupProto_ContactAttachment.Phone: @unchecked Sendable {}
extension BackupProto_ContactAttachment.Phone.TypeEnum: @unchecked Sendable {}
extension BackupProto_ContactAttachment.Email: @unchecked Sendable {}
extension BackupProto_ContactAttachment.Email.TypeEnum: @unchecked Sendable {}
extension BackupProto_ContactAttachment.PostalAddress: @unchecked Sendable {}
extension BackupProto_ContactAttachment.PostalAddress.TypeEnum: @unchecked Sendable {}
extension BackupProto_StickerMessage: @unchecked Sendable {}
extension BackupProto_RemoteDeletedMessage: @unchecked Sendable {}
extension BackupProto_Sticker: @unchecked Sendable {}
extension BackupProto_LinkPreview: @unchecked Sendable {}
extension BackupProto_MessageAttachment: @unchecked Sendable {}
extension BackupProto_MessageAttachment.Flag: @unchecked Sendable {}
extension BackupProto_FilePointer: @unchecked Sendable {}
extension BackupProto_FilePointer.OneOf_Locator: @unchecked Sendable {}
extension BackupProto_FilePointer.BackupLocator: @unchecked Sendable {}
extension BackupProto_FilePointer.AttachmentLocator: @unchecked Sendable {}
extension BackupProto_FilePointer.InvalidAttachmentLocator: @unchecked Sendable {}
extension BackupProto_Quote: @unchecked Sendable {}
extension BackupProto_Quote.TypeEnum: @unchecked Sendable {}
extension BackupProto_Quote.QuotedAttachment: @unchecked Sendable {}
extension BackupProto_BodyRange: @unchecked Sendable {}
extension BackupProto_BodyRange.OneOf_AssociatedValue: @unchecked Sendable {}
extension BackupProto_BodyRange.Style: @unchecked Sendable {}
extension BackupProto_Reaction: @unchecked Sendable {}
extension BackupProto_ChatUpdateMessage: @unchecked Sendable {}
extension BackupProto_ChatUpdateMessage.OneOf_Update: @unchecked Sendable {}
extension BackupProto_IndividualCall: @unchecked Sendable {}
extension BackupProto_IndividualCall.TypeEnum: @unchecked Sendable {}
extension BackupProto_IndividualCall.Direction: @unchecked Sendable {}
extension BackupProto_IndividualCall.State: @unchecked Sendable {}
extension BackupProto_GroupCall: @unchecked Sendable {}
extension BackupProto_GroupCall.State: @unchecked Sendable {}
extension BackupProto_SimpleChatUpdate: @unchecked Sendable {}
extension BackupProto_SimpleChatUpdate.TypeEnum: @unchecked Sendable {}
extension BackupProto_ExpirationTimerChatUpdate: @unchecked Sendable {}
extension BackupProto_ProfileChangeChatUpdate: @unchecked Sendable {}
extension BackupProto_LearnedProfileChatUpdate: @unchecked Sendable {}
extension BackupProto_LearnedProfileChatUpdate.OneOf_PreviousName: @unchecked Sendable {}
extension BackupProto_ThreadMergeChatUpdate: @unchecked Sendable {}
extension BackupProto_SessionSwitchoverChatUpdate: @unchecked Sendable {}
extension BackupProto_GroupChangeChatUpdate: @unchecked Sendable {}
extension BackupProto_GroupChangeChatUpdate.Update: @unchecked Sendable {}
extension BackupProto_GroupChangeChatUpdate.Update.OneOf_Update: @unchecked Sendable {}
extension BackupProto_GenericGroupUpdate: @unchecked Sendable {}
extension BackupProto_GroupCreationUpdate: @unchecked Sendable {}
extension BackupProto_GroupNameUpdate: @unchecked Sendable {}
extension BackupProto_GroupAvatarUpdate: @unchecked Sendable {}
extension BackupProto_GroupDescriptionUpdate: @unchecked Sendable {}
extension BackupProto_GroupMembershipAccessLevelChangeUpdate: @unchecked Sendable {}
extension BackupProto_GroupAttributesAccessLevelChangeUpdate: @unchecked Sendable {}
extension BackupProto_GroupAnnouncementOnlyChangeUpdate: @unchecked Sendable {}
extension BackupProto_GroupAdminStatusUpdate: @unchecked Sendable {}
extension BackupProto_GroupMemberLeftUpdate: @unchecked Sendable {}
extension BackupProto_GroupMemberRemovedUpdate: @unchecked Sendable {}
extension BackupProto_SelfInvitedToGroupUpdate: @unchecked Sendable {}
extension BackupProto_SelfInvitedOtherUserToGroupUpdate: @unchecked Sendable {}
extension BackupProto_GroupUnknownInviteeUpdate: @unchecked Sendable {}
extension BackupProto_GroupInvitationAcceptedUpdate: @unchecked Sendable {}
extension BackupProto_GroupInvitationDeclinedUpdate: @unchecked Sendable {}
extension BackupProto_GroupMemberJoinedUpdate: @unchecked Sendable {}
extension BackupProto_GroupMemberAddedUpdate: @unchecked Sendable {}
extension BackupProto_GroupSelfInvitationRevokedUpdate: @unchecked Sendable {}
extension BackupProto_GroupInvitationRevokedUpdate: @unchecked Sendable {}
extension BackupProto_GroupInvitationRevokedUpdate.Invitee: @unchecked Sendable {}
extension BackupProto_GroupJoinRequestUpdate: @unchecked Sendable {}
extension BackupProto_GroupJoinRequestApprovalUpdate: @unchecked Sendable {}
extension BackupProto_GroupJoinRequestCanceledUpdate: @unchecked Sendable {}
extension BackupProto_GroupSequenceOfRequestsAndCancelsUpdate: @unchecked Sendable {}
extension BackupProto_GroupInviteLinkResetUpdate: @unchecked Sendable {}
extension BackupProto_GroupInviteLinkEnabledUpdate: @unchecked Sendable {}
extension BackupProto_GroupInviteLinkAdminApprovalUpdate: @unchecked Sendable {}
extension BackupProto_GroupInviteLinkDisabledUpdate: @unchecked Sendable {}
extension BackupProto_GroupMemberJoinedByLinkUpdate: @unchecked Sendable {}
extension BackupProto_GroupV2MigrationUpdate: @unchecked Sendable {}
extension BackupProto_GroupV2MigrationSelfInvitedUpdate: @unchecked Sendable {}
extension BackupProto_GroupV2MigrationInvitedMembersUpdate: @unchecked Sendable {}
extension BackupProto_GroupV2MigrationDroppedMembersUpdate: @unchecked Sendable {}
extension BackupProto_GroupExpirationTimerUpdate: @unchecked Sendable {}
extension BackupProto_StickerPack: @unchecked Sendable {}
extension BackupProto_ChatStyle: @unchecked Sendable {}
extension BackupProto_ChatStyle.OneOf_Wallpaper: @unchecked Sendable {}
extension BackupProto_ChatStyle.OneOf_BubbleColor: @unchecked Sendable {}
extension BackupProto_ChatStyle.WallpaperPreset: @unchecked Sendable {}
extension BackupProto_ChatStyle.BubbleColorPreset: @unchecked Sendable {}
extension BackupProto_ChatStyle.Gradient: @unchecked Sendable {}
extension BackupProto_ChatStyle.CustomChatColor: @unchecked Sendable {}
extension BackupProto_ChatStyle.CustomChatColor.OneOf_Color: @unchecked Sendable {}
extension BackupProto_ChatStyle.AutomaticBubbleColor: @unchecked Sendable {}
