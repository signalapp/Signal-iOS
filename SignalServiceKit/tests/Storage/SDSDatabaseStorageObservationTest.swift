...
class SDSDatabaseStorageObservationTest: SSKBaseTestSwift {
    ...
    func testYDBSyncWrite() {
        ...
        self.yapWrite { transaction in
            ...
            someThread = TSContactThread.getOrCreateThread(withContactAddress: recipient, transaction: transaction.asAnyWrite)
        }
        ...
        self.yapWrite { transaction in
            keyValueStore.setBool(true, key: "test", transaction: transaction.asAnyWrite)
        ...
        self.yapWrite { transaction in
            ...
            _ = TSContactThread.getOrCreateThread(withContactAddress: recipient, transaction: transaction.asAnyWrite)
