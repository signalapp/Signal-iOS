...
final class MessageBodyRangesTests: XCTestCase {
    ...
    func testStyleCollapsing_overlappingMentions() {
        ...
        let mentions: [NSRangedValue<Aci>] = [
            NSRangedValue(Aci.randomForTesting(), range: NSRange(location: 2, length: 5)),
        ]
        let styles: [NSRangedValue<SingleStyle>] = [
            .init(.bold, range: NSRange(location: 0, length: 3)),
    ...
    func testDeserializeV1() throws {
        ...
        let expectedResult = MessageBodyRanges(
            mentions: [
                NSRangedValue(Aci.constantForTesting("346FE9B2-C808-4F61-9203-E19238C58EED"), range: NSRange(location: 0, length: 1)),
                NSRangedValue(Aci.constantForTesting("E15977F0-B836-4C02-A473-8D03F89D48C6"), range: NSRange(location: 3, length: 1)),
                NSRangedValue(Aci.constantForTesting("842D05CF-A0F5-4928-98E2-B7E86B901794"), range: NSRange(location: 5, length: 7)),
            ],
            styles: [],
        )
    ...
    func testDeserializeV2() throws {
        ...
        let mentions: [NSRangedValue<Aci>] = [
            NSRangedValue(Aci.constantForTesting("AF406233-B344-4E40-99ED-AD080B8B1ACF"), range: NSRange(location: 0, length: 1)),
            NSRangedValue(Aci.constantForTesting("017447E0-C5A4-456C-A4C1-1EC7F91AC070"), range: NSRange(location: 3, length: 1)),
