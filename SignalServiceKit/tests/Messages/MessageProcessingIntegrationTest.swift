...
class MessageProcessingIntegrationTest: SSKBaseTestSwift {
    ...
    let kLocalRecipientId = "+13235551234"
    let kBobRecipientId = "+18085551234"
    ...
    override func setUp() {
        ...
        tsAccountManager.registerForTests(withLocalNumber: kLocalRecipientId)
        ...
        bobClient = FakeSignalClient.generate(e164Identifier: kBobRecipientId)
...
struct FakeService {
    ...
    func envelopeBuilder(fromSenderClient senderClient: SignalClient) throws -> SSKProtoEnvelope.SSKProtoEnvelopeBuilder {
        ...
        builder.setSourceE164(senderClient.e164Identifier)
