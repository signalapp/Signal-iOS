...
@objc
public extension TSReleaseNotesMessage {
    // NOTE: This method will fail if the object has unexpected type.
    class func fetchReleaseNotesMessageViaCache(
        uniqueId: String,
        transaction: DBReadTransaction
    ) -> TSReleaseNotesMessage? {
        assert(!uniqueId.isEmpty)

        guard let object = fetchViaCache(uniqueId: uniqueId, transaction: transaction) else {
            return nil
        }
        guard let instance = object as? TSReleaseNotesMessage else {
    ...
    // NOTE: This method will fail if the object has unexpected type.
    func anyUpdateReleaseNotesMessage(transaction: DBWriteTransaction, block: (TSReleaseNotesMessage) -> Void) {
...
class TSReleaseNotesMessageSerializer: SDSSerializer {

    private let model: TSReleaseNotesMessage
    public init(model: TSReleaseNotesMessage) {
        self.model = model
    }
    ...
    func asRecord() -> SDSRecord {
        ...
        let recordType: SDSRecordType = .releaseNotesMessage
