...
@implementation YapCollectionsDatabaseSecondaryIndexTransaction

- (id)initWithSecondaryIndexConnection:(YapCollectionsDatabaseSecondaryIndexConnection *)inSecondaryIndexConnection
...
- (BOOL)populate
{
	...
	__unsafe_unretained YapCollectionsDatabaseSecondaryIndex *secondaryIndex = secondaryIndexConnection->secondaryIndex;
	
	if (secondaryIndex->blockType == YapCollectionsDatabaseSecondaryIndexBlockTypeWithKey)
	{
		__unsafe_unretained YapCollectionsDatabaseSecondaryIndexWithKeyBlock block =
		    (YapCollectionsDatabaseSecondaryIndexWithKeyBlock)secondaryIndex->block;
	...
	else if (secondaryIndex->blockType == YapCollectionsDatabaseSecondaryIndexBlockTypeWithObject)
	{
		__unsafe_unretained YapCollectionsDatabaseSecondaryIndexWithObjectBlock block =
		    (YapCollectionsDatabaseSecondaryIndexWithObjectBlock)secondaryIndex->block;
	...
	else if (secondaryIndex->blockType == YapCollectionsDatabaseSecondaryIndexBlockTypeWithMetadata)
	{
		__unsafe_unretained YapCollectionsDatabaseSecondaryIndexWithMetadataBlock block =
		    (YapCollectionsDatabaseSecondaryIndexWithMetadataBlock)secondaryIndex->block;
	...
	else // if (secondaryIndex->blockType == YapCollectionsDatabaseSecondaryIndexBlockTypeWithRow)
	{
		__unsafe_unretained YapCollectionsDatabaseSecondaryIndexWithRowBlock block =
		    (YapCollectionsDatabaseSecondaryIndexWithRowBlock)secondaryIndex->block;
                   ...
                   withRowid:(int64_t)rowid
{
	...
	if (secondaryIndex->blockType == YapCollectionsDatabaseSecondaryIndexBlockTypeWithKey ||
	    secondaryIndex->blockType == YapCollectionsDatabaseSecondaryIndexBlockTypeWithObject)
	{
	...
	else
	{
		...
		if (secondaryIndex->blockType == YapCollectionsDatabaseSecondaryIndexBlockTypeWithMetadata)
		{
			__unsafe_unretained YapCollectionsDatabaseSecondaryIndexWithMetadataBlock block =
		        (YapCollectionsDatabaseSecondaryIndexWithMetadataBlock)secondaryIndex->block;
