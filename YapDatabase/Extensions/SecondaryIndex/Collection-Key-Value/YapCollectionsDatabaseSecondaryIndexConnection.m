...
@implementation YapCollectionsDatabaseSecondaryIndexConnection
{
...
- (id)initWithSecondaryIndex:(YapCollectionsDatabaseSecondaryIndex *)inSecondaryIndex
...
{
	YapCollectionsDatabaseSecondaryIndexTransaction *transaction =
	    [[YapCollectionsDatabaseSecondaryIndexTransaction alloc]
