...
@class YapCollectionsDatabaseSecondaryIndex;


@interface YapCollectionsDatabaseSecondaryIndexConnection : YapAbstractDatabaseExtensionConnection

/**
 * Returns the parent instance.
**/
@property (nonatomic, strong, readonly) YapCollectionsDatabaseSecondaryIndex *secondaryIndex;
