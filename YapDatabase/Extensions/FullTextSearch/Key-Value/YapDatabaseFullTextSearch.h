...
**/
typedef enum {
	YapDatabaseFullTextSearchBlockTypeWithKey       = 101,
	YapDatabaseFullTextSearchBlockTypeWithObject    = 102,
	YapDatabaseFullTextSearchBlockTypeWithMetadata  = 103,
	YapDatabaseFullTextSearchBlockTypeWithRow       = 104
