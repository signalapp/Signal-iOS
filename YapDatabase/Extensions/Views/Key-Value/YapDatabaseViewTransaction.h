...
typedef NSComparisonResult (^YapDatabaseViewFindWithKeyBlock)(NSString *key);
typedef NSComparisonResult (^YapDatabaseViewFindWithObjectBlock)(NSString *key, id object);
typedef NSComparisonResult (^YapDatabaseViewFindWithMetadataBlock)(NSString *key, id metadata);
typedef NSComparisonResult (^YapDatabaseViewFindWithRowBlock)(NSString *key, id object, id metadata);
