...
@implementation YapCollectionsDatabaseFilteredViewTransaction (ReadWrite)

- (void)setFilteringBlock:(YapCollectionsDatabaseViewFilteringBlock)inFilteringBlock
