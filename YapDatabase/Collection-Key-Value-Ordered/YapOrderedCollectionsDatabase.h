...
/**
 * This class extendes YapCollectionsDatabase.
 * It provides ordering for objects that otherwise have no explicit ordering.
 *
 * YapCollectionsDatabase is a collection-key-value storage facility.
...
**/
@interface YapOrderedCollectionsDatabase : YapCollectionsDatabase

/* Inherited from YapCollectionsDatabase
...
@property (nonatomic, strong, readonly) NSData *(^serializer)(id object);
@property (nonatomic, strong, readonly) id (^deserializer)(NSData *data);
