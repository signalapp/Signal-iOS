...
def shared_pods
  ...
  # pod 'ZKGroup', git: 'git@github.com:signalapp/signal-zkgroup-swift', branch: 'trevor/ios1', testspecs: ["Tests"]
  pod 'ZKGroup', git: 'git@github.com:signalapp/signal-zkgroup-swift', branch: 'charlesmchen/missingHeader', testspecs: ["Tests"]
...
def configure_bitcode(installer)
  installer.pods_project.targets.each do |target|
