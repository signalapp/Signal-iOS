...
def shared_pods
  ...
  pod 'AxolotlKit', git: 'https://github.com/signalapp/SignalProtocolKit.git', testspecs: ["Tests"], branch: 'charlesmchen/sck'
  # pod 'AxolotlKit', path: '../SignalProtocolKit', testspecs: ["Tests"]
  # pod 'AxolotlKit', path: '../SignalProtocolKit'
  pod 'HKDFKit', git: 'https://github.com/signalapp/HKDFKit.git', testspecs: ["Tests"], branch: 'charlesmchen/sck'
  # pod 'HKDFKit', path: '../HKDFKit', testspecs: ["Tests"]
  pod 'Curve25519Kit', git: 'https://github.com/signalapp/Curve25519Kit', testspecs: ["Tests"], branch: 'charlesmchen/sck'
  # pod 'Curve25519Kit', path: '../Curve25519Kit', testspecs: ["Tests"]
  pod 'SignalMetadataKit', git: 'https://github.com/signalapp/SignalMetadataKit', testspecs: ["Tests"], branch: 'charlesmchen/sck'
