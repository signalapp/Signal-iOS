...
class AttachmentCaptionViewController: OWSViewController {
    ...
    private lazy var lengthLimitLabel: UILabel = {
        ...
        lengthLimitLabel.text = NSLocalizedStringFromAppBundle("ATTACHMENT_APPROVAL_CAPTION_LENGTH_LIMIT_REACHED", comment: "One-line label indicating the user can add no more text to the attachment caption.")
    ...
    private lazy var placeholderTextView: UIView = {
        ...
        placeholderTextView.text = NSLocalizedStringFromAppBundle("ATTACHMENT_APPROVAL_CAPTION_PLACEHOLDER", comment: "placeholder text for an empty captioning field")
