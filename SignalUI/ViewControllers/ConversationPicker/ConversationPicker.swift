...
open class ConversationPickerViewController: OWSTableViewController2 {
    ...
    private func updateTableContents() {
        ...
        if conversationCollection.isSearchResults,
           !hasContents {
            let section = OWSTableSection()
            section.add(.label(withText: NSLocalizedStringFromAppBundle("CONVERSATION_SEARCH_NO_RESULTS",
    ...
    private func showBlockedByAnnouncementOnlyToast() {
        ...
        let toastFormat = NSLocalizedStringFromAppBundle("CONVERSATION_PICKER_BLOCKED_BY_ANNOUNCEMENT_ONLY",
    ...
    private func showTooManySelectedToast() {
        ...
        let toastFormat = NSLocalizedStringFromAppBundle("CONVERSATION_PICKER_CAN_SELECT_NO_MORE_CONVERSATIONS",
...
extension ConversationPickerViewController {
    private struct Strings {
        static let title = NSLocalizedStringFromAppBundle("CONVERSATION_PICKER_TITLE", comment: "navbar header")
        static let recentsSection = NSLocalizedStringFromAppBundle("CONVERSATION_PICKER_SECTION_RECENTS", comment: "table section header for section containing recent conversations")
        static let signalContactsSection = NSLocalizedStringFromAppBundle("CONVERSATION_PICKER_SECTION_SIGNAL_CONTACTS", comment: "table section header for section containing contacts")
        static let groupsSection = NSLocalizedStringFromAppBundle("CONVERSATION_PICKER_SECTION_GROUPS", comment: "table section header for section containing groups")
    }
}
