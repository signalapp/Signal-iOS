...
public class CountryCodeViewController: OWSTableViewController2 {
    ...
    override public func viewDidLoad() {
        ...
        searchBar.placeholder = NSLocalizedStringFromAppBundle("SEARCH_BYNAMEORNUMBER_PLACEHOLDER_TEXT", comment: "")
        searchBar.sizeToFit()
        ...
        self.title = NSLocalizedStringFromAppBundle("COUNTRYCODE_SELECT_TITLE", comment: "")
