...
public class DisappearingTimerConfigurationView: UIView {
    ...
    public init(durationSeconds: UInt32) {
        ...
        // Accessibility
        self.accessibilityLabel = NSLocalizedStringFromAppBundle("DISAPPEARING_MESSAGES_LABEL", comment: "Accessibility label for disappearing messages")
        let hintFormatString = NSLocalizedStringFromAppBundle("DISAPPEARING_MESSAGES_HINT", comment: "Accessibility hint that contains current timeout information")
