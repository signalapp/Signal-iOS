...
extension OWSDatabaseMigration {
    ...
    public class func anyFetch(uniqueId: String,
        ...
        case .grdbRead(let grdbTransaction):
            let tableMetadata = OWSDatabaseMigrationSerializer.table
            ...
            let uniqueIdColumnName: String = OWSDatabaseMigrationSerializer.uniqueIdColumn.columnName
            ...
            let cursor = OWSDatabaseMigration.grdbFetchCursor(sql: sql,
                                                  arguments: [uniqueId],
