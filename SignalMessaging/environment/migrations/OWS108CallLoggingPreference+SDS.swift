...
class OWS108CallLoggingPreferenceSerializer: SDSSerializer {

    private let model: OWS108CallLoggingPreference
    public required init(model: OWS108CallLoggingPreference) {
        self.model = model
    }
    ...
    func toRecord() throws -> DatabaseMigrationRecord {
        ...
        let recordType: SDSRecordType = ._108CallLoggingPreference
