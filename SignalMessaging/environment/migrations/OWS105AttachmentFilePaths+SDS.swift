...
class OWS105AttachmentFilePathsSerializer: SDSSerializer {

    private let model: OWS105AttachmentFilePaths
    public required init(model: OWS105AttachmentFilePaths) {
        self.model = model
    }
    ...
    func toRecord() throws -> DatabaseMigrationRecord {
        ...
        let recordType: SDSRecordType = ._105AttachmentFilePaths
