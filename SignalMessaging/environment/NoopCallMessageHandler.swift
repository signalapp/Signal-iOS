...
public class NoopCallMessageHandler: NSObject, OWSCallMessageHandler {
    ...
    public func receivedOffer(_ offer: SSKProtoCallMessageOffer, from caller: SignalServiceAddress, sourceDevice device: UInt32, sentAtTimestamp: UInt64, fromLegacyDevice: Bool) {
        owsFailDebug("")
    }

    public func receivedAnswer(_ answer: SSKProtoCallMessageAnswer, from caller: SignalServiceAddress, sourceDevice device: UInt32, fromLegacyDevice: Bool) {
        owsFailDebug("")
    }
