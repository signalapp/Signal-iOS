#ifndef SWORDCOMM_IOS_PLATFORM_H
#define SWORDCOMM_IOS_PLATFORM_H

// iOS Platform Definitions for SWORDCOMM Security
...
#define SWORDCOMM_LOG_DEBUG(fmt, ...) os_log_debug(emma::platform::emma_log, fmt, ##__VA_ARGS__)
#define SWORDCOMM_LOG_INFO(fmt, ...) os_log_info(emma::platform::emma_log, fmt, ##__VA_ARGS__)
#define SWORDCOMM_LOG_ERROR(fmt, ...) os_log_error(emma::platform::emma_log, fmt, ##__VA_ARGS__)
...
#endif // SWORDCOMM_IOS_PLATFORM_H
