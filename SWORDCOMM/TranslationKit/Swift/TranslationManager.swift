...
//
//  Swift API for SWORDCOMM translation features
//
...
public class TranslationManager {
    ...
    private let cacheQueue = DispatchQueue(label: "im.swordcomm.swordcomm.translation.cache")
    ...
    public func initialize(modelPath: String) -> Bool {
        ...
        if success {
            NSLog("[SWORDCOMM] Translation Manager initialized with model: %@", modelPath)
        } else {
            NSLog("[SWORDCOMM] Failed to initialize Translation Manager")
        }
        return success
    }
    ...
    public func initializeFromBundle(modelName: String) -> Bool {
        guard let modelPath = Bundle.main.path(forResource: modelName, ofType: "mlmodel") else {
            NSLog("[SWORDCOMM] Model file not found in bundle: %@", modelName)
            return false
        }
    ...
    public func clearCache() {
        ...
        NSLog("[SWORDCOMM] Translation cache cleared")
    }
    ...
    public func resetStatistics() {
        ...
        NSLog("[SWORDCOMM] Translation statistics reset")
    }
}
