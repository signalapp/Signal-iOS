Pod::Spec.new do |s|
  s.name             = 'SWORDCOMMTranslationKit'
  s.version          = '1.0.0'
  s.summary          = 'SWORDCOMM Translation Framework for iOS'
  s.description      = <<-DESC
    Secure Worldwide Operations Enterprise Messaging Military-grade Android Real-time Data Communication (SWORDCOMM) translation features ported to iOS.
  ...
  # Dependencies
  s.dependency 'SWORDCOMMSecurityKit', '~> 1.0.0'
  ...
  # Info.plist
  s.info_plist = {
    'CFBundleIdentifier' => 'im.swordcomm.swordcomm.translation'
  }
end
