...
//  SWORDCOMM Cross-Platform Compatibility Tests
//
...
class CrossPlatformCompatibilityTests: XCTestCase {
    ...
    func testMLDSA87SignAndVerify() {
        ...
        let message = "Hello from SWORDCOMM iOS!".data(using: .utf8)!
    ...
    func testHKDFDerivation() {
        ...
        // Derive AES-256 key
        let info = "SWORDCOMM-AES-256-GCM-KEY".data(using: .utf8)!
    ...
    func testAndroidCompatibilityVectors() {
        // These test vectors should be generated by SWORDCOMM-Android
        ...
        // TODO: Add actual test vectors from SWORDCOMM-Android
    ...
    func testFullCryptoWorkflow() {
        // Simulate a complete SWORDCOMM encrypted message exchange
