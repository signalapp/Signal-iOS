...
OUTPUT_DIR="$PROJECT_ROOT/SWORDCOMM/Frameworks"
...
print_integration_instructions() {
    ...
    echo "   - Look for: [SWORDCOMM] Running in PRODUCTION CRYPTO mode"
    echo ""
    echo "4. Update SWORDCOMM wrapper (if needed):"
    ...
    echo "  - SWORDCOMM/LIBOQS_INTEGRATION.md"
