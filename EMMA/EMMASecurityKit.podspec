Pod::Spec.new do |s|
  ...
  s.version          = '1.0.0'
  s.summary          = 'EMMA Security Framework for iOS'
  s.description      = <<-DESC
    Enterprise Messaging Military-grade Android (EMMA) security features ported to iOS.
  ...
  # Info.plist
  s.info_plist = {
    'CFBundleIdentifier' => 'im.swordcomm.emma.security'
  }
end
