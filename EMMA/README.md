# EMMA iOS Port - Foundation Phase

**Enterprise Messaging Military-grade Android** ported to iOS

This directory contains the iOS port of EMMA security and translation features from the Android version. The implementation maintains API compatibility while adapting to iOS-specific constraints and APIs.
...
1. Drag the `EMMA` folder into your Xcode project
...
# Add include paths
HEADER_SEARCH_PATHS = $(PROJECT_DIR)/EMMA/Common \
...
```objc
#import "EMMA/SecurityKit/Bridge/EMSecurityKit.h"
#import "EMMA/TranslationKit/Bridge/EMTranslationKit.h"
```
...
- [EMMA-Android](https://github.com/SWORDIntel/EMMA-android) - Original Android implementation
