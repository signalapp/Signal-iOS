//
//  EMMASettingsView.swift
//  EMMA Settings Panel
//
//  Comprehensive settings view for EMMA security and translation features
//

import SwiftUI

/// Main EMMA settings panel for integration into Signal Settings
@available(iOS 15.0, *)
public struct EMMASettingsView: View {
    @StateObject private var viewModel = EMMASettingsViewModel()
    ...
    public var body: some View {
        Form {
            ...
            Section(header: Text("About")) {
                ...
                NavigationLink(destination: AboutEMMAView()) {
                    Text("About EMMA")
                }
            }
        }
...
@available(iOS 15.0, *)
@MainActor
class EMMASettingsViewModel: ObservableObject {
    // Security settings
    ...
    func loadSettings() {
        ...
        securityMonitoringEnabled = defaults.bool(forKey: "EMMA.SecurityMonitoring") != false // Default true
        autoCountermeasuresEnabled = defaults.bool(forKey: "EMMA.AutoCountermeasures")
        countermeasureIntensity = defaults.double(forKey: "EMMA.CountermeasureIntensity") != 0 ?
            defaults.double(forKey: "EMMA.CountermeasureIntensity") : 0.5

        translationEnabled = defaults.bool(forKey: "EMMA.Translation") != false // Default true
        autoTranslateEnabled = defaults.bool(forKey: "EMMA.AutoTranslate")
        networkFallbackEnabled = defaults.bool(forKey: "EMMA.NetworkFallback") != false // Default true

        sourceLanguage = defaults.string(forKey: "EMMA.SourceLanguage") ?? "da"
        targetLanguage = defaults.string(forKey: "EMMA.TargetLanguage") ?? "en"

        showSecurityHUD = defaults.bool(forKey: "EMMA.ShowSecurityHUD")
        performanceMonitoringEnabled = defaults.bool(forKey: "EMMA.PerformanceMonitoring") != false
    ...
    func saveSettings() {
        ...
        defaults.set(securityMonitoringEnabled, forKey: "EMMA.SecurityMonitoring")
        defaults.set(autoCountermeasuresEnabled, forKey: "EMMA.AutoCountermeasures")
        defaults.set(countermeasureIntensity, forKey: "EMMA.CountermeasureIntensity")

        defaults.set(translationEnabled, forKey: "EMMA.Translation")
        defaults.set(autoTranslateEnabled, forKey: "EMMA.AutoTranslate")
        defaults.set(networkFallbackEnabled, forKey: "EMMA.NetworkFallback")

        defaults.set(sourceLanguage, forKey: "EMMA.SourceLanguage")
        defaults.set(targetLanguage, forKey: "EMMA.TargetLanguage")

        defaults.set(showSecurityHUD, forKey: "EMMA.ShowSecurityHUD")
        defaults.set(performanceMonitoringEnabled, forKey: "EMMA.PerformanceMonitoring")
    }
...
// MARK: - About EMMA View

@available(iOS 15.0, *)
struct AboutEMMAView: View {
    var body: some View {
        Form {
            Section(header: Text("EMMA")) {
                VStack(alignment: .leading, spacing: 8) {
                    Text("Enterprise Messaging Military-grade Android (iOS Port)")
                        .font(.system(size: 15))
            ...
            Section(header: Text("Credits")) {
                ...
                Text("Based on EMMA-Android")
                    .font(.system(size: 13))
                    .foregroundColor(.secondary)
            }
        }
        .navigationTitle("About EMMA")
    }
}
...
@available(iOS 15.0, *)
struct EMMASettingsView_Previews: PreviewProvider {
