# EMMA NIST Post-Quantum Cryptography Compliance
...
EMMA now implements **NIST-standardized post-quantum cryptography** algorithms:
...
EMMA uses a **hybrid protocol** combining all three algorithms:
...
**Header**: `EMMA/SecurityKit/Native/nist_pqc.h`
...
**Header**: `EMMA/SecurityKit/Bridge/EMSecurityKit.h`
...
EMMA iOS and EMMA Android use **identical algorithms and key sizes**:
...
```
iOS (EMMA)  ←─── ML-KEM + ML-DSA + AES-GCM ───→  Android (EMMA)
     ↓                                                    ↓
