...
// @objc
// public class CVComponentUnknownThreadWarning: CVComponentBase, CVRootComponent {
//
//    public var cellReuseIdentifier: CVCellReuseIdentifier {
//        CVCellReuseIdentifier.unknownThreadWarning
//    }
//
//    public let isDedicatedCell = true
//
//    private let unknownThreadWarning: CVComponentState.UnknownThreadWarning
//
//    typealias Action = CVMessageAction
//    fileprivate var action: Action? { unknownThreadWarning.action }
//
//    required init(itemModel: CVItemModel, unknownThreadWarning: CVComponentState.UnknownThreadWarning) {
...
//        CVComponentViewUnknownThreadWarning()
//    }
//
//    public func configureForRendering(componentView: CVComponentView,
//                                      cellMeasurement: CVCellMeasurement,
//                                      componentDelegate: CVComponentDelegate) {
//        guard let componentView = componentView as? CVComponentViewUnknownThreadWarning else {
...
//           !itemViewState.shouldCollapseUnknownThreadWarningAction,
...
//        CVLabelConfig(attributedText: unknownThreadWarning.title,
//                      font: Self.titleLabelFont,
//                      textColor: unknownThreadWarning.titleColor,
//                      numberOfLines: 0,
...
//    }
//
//    private static let measurementKey_outerHStack = "CVComponentUnknownThreadWarning.measurementKey_outerHStack"
//    private static let measurementKey_innerVStack = "CVComponentUnknownThreadWarning.measurementKey_innerVStack"
//    private static let measurementKey_outerVStack = "CVComponentUnknownThreadWarning.measurementKey_outerVStack"
//    private static let measurementKey_buttonSize = "CVComponentUnknownThreadWarning.measurementKey_buttonSize"
//
...
//        if let action = action, !itemViewState.shouldCollapseUnknownThreadWarningAction {
//            let buttonLabelConfig = self.buttonLabelConfig(action: action)
...
//        }
//
//        if let action = unknownThreadWarning.action {
...
//                                  gestureLocation: .unknownThreadWarning)
//    }
//
//    // MARK: -
//
...
//    @objc
//    public class CVComponentViewUnknownThreadWarning: NSObject, CVComponentView {
//
//        fileprivate let outerHStack = ManualStackView(name: "unknownThreadWarning.outerHStack")
//        fileprivate let innerVStack = ManualStackView(name: "unknownThreadWarning.innerVStack")
//        fileprivate let outerVStack = ManualStackView(name: "unknownThreadWarning.outerVStack")
...
// MARK: -
//
// extension CVComponentUnknownThreadWarning {
//
//    static func buildComponentState(interaction: TSInteraction,
//                                    threadViewModel: ThreadViewModel,
//                                    currentCallThreadId: String?,
//                                    transaction: SDSAnyReadTransaction) -> CVComponentState.UnknownThreadWarning {
//
...
//
//        return CVComponentState.UnknownThreadWarning(title: title, titleColor: titleColor, action: action)
//    }
//
...
//        }
//
//        let unknownThreadWarningText = Self.unknownThreadWarningText(forInteraction: interaction,
//                                                       transaction: transaction)
//        owsAssertDebug(!unknownThreadWarningText.isEmpty)
//        labelText.append(unknownThreadWarningText)
//
...
//    }
//
//    private static func unknownThreadWarningText(forInteraction interaction: TSInteraction,
...
//            return infoMessage.unknownThreadWarningText(with: transaction)
