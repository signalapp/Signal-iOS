...
class GalleryRailView: UIView, GalleryRailCellViewDelegate {
    ...
    public func configure(itemProvider: GalleryRailItemProvider?, focusedItem: GalleryRailItem?) {
        ...
        let sameRailItems = { (lhs: [GalleryRailItem], rhs: [GalleryRailItem]) -> Bool in
        ...
        if itemProvider === self.itemProvider, sameRailItems(itemProvider.railItems, self.cellViewItems) {
            UIView.animate(withDuration: animationDuration) {
