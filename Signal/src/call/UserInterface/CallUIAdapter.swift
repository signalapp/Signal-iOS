...
extension CallUIAdaptee {
    internal func showCall(_ call: SignalCall) {
        ...
        guard let mainWindow = CurrentAppContext().mainWindow else {
            owsFail("in \(#function) mainWindow unexpectedly nil")
            return
        }
        guard let presentingViewController = mainWindow.rootViewController else {
