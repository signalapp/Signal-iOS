...
//    if (![self writeUserDefaults:NSUserDefaults.d
...
- (BOOL)enqueueBackupRestore
{
    ...
    [[NSUserDefaults standardUserDefaults] setObject:relativePath forKey:NSUserDefaults_QueuedBackupPath];
...
- (void)completeImportBackupIfPossible
{
    ...
    NSString *_Nullable queuedBackupRelativePath =
        [[NSUserDefaults standardUserDefaults] stringForKey:NSUserDefaults_QueuedBackupPath];
...
//    }
    ...
    [TSStorageManager storeDatabasePassword:databasePassword];
}
...
+ (void)cleanupBackupState
{
    ...
    [[NSUserDefaults standardUserDefaults] removeObjectForKey:NSUserDefaults_QueuedBackupPath];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
