...
class AccountManagerTest: XCTestCase {
    ...
    let tsAccountManager = FailingTSAccountManager(networkManager: TSNetworkManager.shared(), primaryStorage: OWSPrimaryStorage.sharedManager())
    ...
    func testSuccessfulRegistration() {
        ...
        let tsAccountManager = TokenObtainingTSAccountManager(networkManager: TSNetworkManager.shared(), primaryStorage: OWSPrimaryStorage.sharedManager())
