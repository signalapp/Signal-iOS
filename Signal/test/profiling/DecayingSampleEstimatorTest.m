...
-(void) testDecayingSampleEstimator {
    DecayingSampleEstimator* e = [[DecayingSampleEstimator alloc] initWithInitialEstimate:1.0 andDecayPerUnitSample:0.5];
...
-(void) testDecayingSampleEstimatorQuarter {
    DecayingSampleEstimator* e = [[DecayingSampleEstimator alloc] initWithInitialEstimate:1.0 andDecayPerUnitSample:0.75];
    test(e.currentEstimate == 1.0);
...
-(void) testDecayingSampleEstimatorCustomDecayPeriod {
    DecayingSampleEstimator* e = [[DecayingSampleEstimator alloc] initWithInitialEstimate:0 andDecayFactor:0.75 perNSamples:2];
    test([e decayRatePerUnitSample] == 0.5);
...
-(void) testDecayingSampleEstimatorWeighted {
    DecayingSampleEstimator* e1 = [[DecayingSampleEstimator alloc] initWithInitialEstimate:0.0 andDecayPerUnitSample:0.25];
    DecayingSampleEstimator* e2 = [[DecayingSampleEstimator alloc] initWithInitialEstimate:0.0 andDecayPerUnitSample:0.25];
...
-(void) testDecayingSampleEstimatorCornerCase0 {
    DecayingSampleEstimator* e = [[DecayingSampleEstimator alloc] initWithInitialEstimate:1.0 andDecayPerUnitSample:0];
...
-(void) testDecayingSampleEstimatorCornerCase1 {
    DecayingSampleEstimator* e = [[DecayingSampleEstimator alloc] initWithInitialEstimate:1.0 andDecayPerUnitSample:1];
