...
-(void) testTrivial {
    ...
    testThrows([[EncodedAudioPacket alloc] initWithAudioData:nil andSequenceNumber:0]);
    EncodedAudioPacket* p2 = [[EncodedAudioPacket alloc] initWithAudioData:d2 andSequenceNumber:0xFF00];
