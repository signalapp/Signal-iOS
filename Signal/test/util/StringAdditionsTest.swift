...
class StringAdditionsTest: SignalBaseTest {
    ...
    func test_filterAsE164() {
        ...
        XCTAssertEqual("+123+123", ("abc+123+123zz" as NSString).filterAsE164())
        XCTAssertEqual("+123+123", (("+123" + "مرحبا بالعالم" + "abc+123zz") as NSString).filterAsE164())
        XCTAssertEqual("+123+123", ("abc+123zz+123" as NSString).filterAsE164())
        XCTAssertEqual("+123+123", ("abc+123zz+123🇨🇦" as NSString).filterAsE164())
        XCTAssertEqual("", ("🇨🇦" as NSString).filterAsE164())
